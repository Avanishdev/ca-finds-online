...
const Bottom = () => {
    return (
      ...
      <div className=" absolute bottom-[0.47px] left-[0px] flex flex-col items-start justify-start text-left text-sm text-fs-search-button-text font-open-sans">
        ...
        <footer className=" relative bg-black w-[100%] h-[57px] text-center text-xs">
          <div className="absolute top-[calc(50%_-_7.5px)] left-[calc(50%_-_254px)]">
            Registered trademark of India Private Limited © 2023 ABC Inc.
            All Rights Reserved
          </div>
        </footer>
      </div>
