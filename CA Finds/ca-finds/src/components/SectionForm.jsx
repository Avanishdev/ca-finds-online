...
const SectionForm = () => {
    return (
      <div className="absolute top-[935px] left-[calc(50%_-_774px)] w-[1542px] h-[897px] text-left text-base text-black font-poppins">
        ...
        <b className="absolute top-[228.5px] left-[149px] text-16xl flex font-open-sans text-fs-search-button-text items-center w-[24.38px] h-[37.14px]">
          1
        </b>
        ...
        <div className="absolute top-[373.5px] left-[181px] w-[315px] h-[93px] font-open-sans">
          ...
          <div className="absolute top-[0px] left-[0px] w-[115px] h-[84px]">
            ...
            <b className="absolute top-[0px] left-[0px] text-lg leading-[28px] inline-block text-fs-search-primary w-[105.96px]">
              Due date
            </b>
          </div>
        </div>
        <div className="absolute top-[259.5px] left-[165px] text-xl text-center inline-block w-[341px]">
          <b>Commencement of business</b>
          <i className="font-bold">{` `}</i>
        </div>
        <div className="absolute top-[225px] left-[126px] rounded-3xs [background:linear-gradient(95.64deg,_#0076ce,_#9400d3)] w-[50px] h-[46px]" />
        ...
        <div className="absolute top-[224px] left-[563px] rounded-3xs [background:linear-gradient(95.64deg,_#0076ce,_#9400d3)] w-[53px] h-[46px]" />
        ...
        <div className="absolute top-[535px] left-[1001px] rounded-3xs [background:linear-gradient(95.64deg,_#0076ce,_#9400d3)] w-[50px] h-[46px]" />
        ...
        <b className="absolute top-[685px] left-[618px] text-lg leading-[28px] inline-block text-fs-search-primary w-[105.96px]">
          Due date
        </b>
        <b className="absolute top-[571px] left-[602px] text-xl inline-block text-center w-[341px]">
          MCA Form AOC-4
        </b>
        <div className="absolute top-[536px] left-[563px] rounded-3xs [background:linear-gradient(95.64deg,_#0076ce,_#9400d3)] w-[50px] h-[46px]" />
        ...
        <div className="absolute top-[536px] left-[126px] rounded-3xs [background:linear-gradient(95.64deg,_#0076ce,_#9400d3)] w-[50px] h-[46px]" />
        ...
        <div className="absolute top-[224px] left-[1001px] rounded-3xs [background:linear-gradient(95.64deg,_#0076ce,_#9400d3)] w-[50px] h-[46px]" />
