...
const SearchFormContainer = () => {
    return (
        <div className="absolute top-[1964px] left-[128px] w-[1279.6px] h-[614.53px] text-left text-sm text-black font-poppins">
        <img
            className="absolute top-[356px] left-[0px] w-[65px] h-[65px] overflow-hidden"
            alt=""
            src="../images/icon-park-twotone_search.svg"
        />
        ...
        <img
            ...
            alt=""
            src="../images/icon-park-twotone_enquire.svg"
        />
        ...
        <img
            ...
            alt=""
            src="../images/icon-park-twotone_table-report.svg"
        />
        ...
        <img
            ...
            alt=""
            src="../images/icon-park-twotone_degree-hat.svg"
        />
        <div className="absolute top-[516px] left-[calc(50%_-_240.8px)] w-[205px] h-24 text-xl font-open-sans">
            <div className="absolute top-[0px] left-[calc(50%_-_102.5px)] leading-[32px] inline-block w-[205px]">
            <b>ACADEMY</b>
        ...
        <p className="m-0">
            <span className="[background-image:linear-gradient(90.28deg,_#0076ce,_#9400d3)] [background-clip:text] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                All-in-One
            </span>
            <span> platform</span>
            </p>
        ...
        <img className="absolute h-[5.23%] w-[2.96%] top-[48.77%] right-[23.68%] bottom-[0%] left-[50%] max-w-full overflow-hidden max-h-full object-cover"
        src="../images/close.svg"
        alt="image.com"/>
        <img className="absolute h-[56.23%] w-[23.96%] top-[49.44%] right-[23.68%] bottom-[0%] left-[52.36%] max-w-full overflow-hidden max-h-full object-cover"
            src="../images/vector-teacher.svg"
        />
        <img
            className="absolute h-[56.58%] w-[21.13%] top-[0%] right-[0%] bottom-[43.42%] left-[80.87%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="../images/student_image.png"
        />
        <div className="absolute top-[55px] left-[769px] bg-fs-search-button-text  flex flex-col items-end justify-center font-open-sans">
        ...
        <img
            className="absolute h-[56.23%] w-[23.96%] top-[48.77%] right-[23.68%] bottom-[0%] left-[52.36%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="../images/teacher_image.png"
        />
        <img className="absolute h-[20px] w-[30px] shrink-0 top-[8%] right-[33.68%] bottom-[0%] left-[83%]  max-w-full overflow-hidden max-h-full object-cover fill-[#EFD9F9]"
        src="../images/plus.svg"
        alt="image.com"/>
        {/* <img className="absolute h-[231px] w-[308px] shrink-0 top-[8%] right-[33.68%] bottom-[0%] left-[83%]  max-w-full overflow-hidden max-h-full object-cover fill-[#EFD9F9];"
        src="../images/vector-student.svg"
        /> */}
